...
## [index.d.ts](https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/smtpapi/index.d.ts)
````ts
...
# Credits
These definitions were written by [Antonio Morales](https://github.com/a-morales).
